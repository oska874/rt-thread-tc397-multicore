...
#define IFX_CFG_CPU_TRAP_SYSCALL_CPU2_HOOK(trapInfo) tricore2_trap_yield_for_task((trapInfo).tId)
#define IFX_CFG_CPU_TRAP_SYSCALL_CPU3_HOOK(trapInfo) tricore3_trap_yield_for_task((trapInfo).tId)
#define IFX_CFG_CPU_TRAP_SYSCALL_CPU4_HOOK(trapInfo) tricore4_trap_yield_for_task((trapInfo).tId)
#define IFX_CFG_CPU_TRAP_SYSCALL_CPU5_HOOK(trapInfo) tricore5_trap_yield_for_task((trapInfo).tId)
